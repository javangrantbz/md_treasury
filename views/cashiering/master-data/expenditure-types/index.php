        ...
        <div class="card-body py-3">
          <div class="d-flex align-items-center gap-3 flex-wrap">
            <div class="me-auto">
              ...
              <div class="fw-bold" style="font-size:1.05rem;line-height:1.2;">Expenditure Types</div>
            </div>
            ...
            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-add">Add Expenditure Type</button>
          </div>
        </div>
      </div>
...
const DETAILS_PAGE = "<?= url('views/cashiering/master-data/expenditure-types/details.php') ?>";
