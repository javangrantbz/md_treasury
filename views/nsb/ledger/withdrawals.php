    ...
    <div class="container-xl">
      <div class="row align-items-center">
        <div class="col">
          ...
          <h2 class="page-title">Withdrawal Ledger</h2>
        </div>
    ...
    <div class="container-xl">
      <div class="card">
        <div class="card-header d-flex gap-2">
          <input type="text" id="search-input" class="form-control form-control-sm w-auto" placeholder="Search withdrawals...">
        </div>
        <div class="card-body p-0">
          ...
          <div class="table-responsive">
            <table class="table table-vcenter table-hover card-table">
              ...
              <tbody id="table-body">
                <tr><td colspan="10" class="text-center py-4 text-muted">No withdrawal records found.</td></tr>
              </tbody>
            </table>
          </div>
...
<script>
const LIST_URL = "<?= url('api/nsb/ledger/list.php') ?>?type=withdrawal";
...
function renderRow(r) {
  return `<tr>
    ...
    <td class="text-danger fw-bold">${r.amount ? 'BZD ' + parseFloat(r.amount).toLocaleString(undefined, {minimumFractionDigits: 2}) : '—'}</td>
    <td>${r.method ?? '—'}</td>
...
function renderTable(rows) {
  if (rows.length === 0) {
    document.getElementById('table-body').innerHTML = '<tr><td colspan="10" class="text-center py-4 text-muted">No withdrawal records found.</td></tr>';
    return;
  }
