...
try {
    ...
    $sql = "SELECT u.id, u.username, u.email, u.phone, u.first_name, u.last_name,
                   ...
                   u.branch_id, u.department_id, u.sub_treasury_id, u.register_id,
                   b.name AS branch_name, d.name AS department_name,
                   st.sub_treasury_name, r.register_name,
    ...
    if ($registerId    > 0)    { $sql .= " AND u.register_id = :register_id";         $params['register_id']     = $registerId; }
    if ($onlyUnassigned === 1) { $sql .= " AND u.register_id IS NULL"; }
